	...
	<nav class="navbar navbar-default">
		...
		<section class="konten">
			...
			<table class="table table-bordered">
				...
				<tbody>
					...
					<?php foreach ($_SESSION["keranjang"] as $id_produk => $jumlah): ?>
						<!--menampilkan produk yang sedang di perlukan bedasarkan id_produk -->
						<?php
			...
			if (isset($_POST["checkout"]))
			{
				...
				//mendapatkan id_pelanggan baru terjadi
				...
				//tampilan dialihkan ke halaman nota, nota pembelian dari yang baru
